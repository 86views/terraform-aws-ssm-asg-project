...
# --- COST OPTIMIZED NAT GATEWAY (Only 1 for the whole VPC) ---
...
resource "aws_nat_gateway" "main" {
  ...
  subnet_id     = aws_subnet.public[0].id # Always put it in the first public subnet
...
resource "aws_route_table" "private" {
  ...
  # This route only exists if NAT is enabled
  dynamic "route" {
